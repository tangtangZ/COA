...
public class AddTest {
    ...
    private final String opcode = String.valueOf((char) 0x05);
    ...
    public void test1() {
        ...
        assertEquals(alu.add(new DataType(a), new DataType(a)).toString(), CPU_State.eax.read());
    }
    ...
    public void test2() {
        ...
        CPU_State.eax.write(a);
        assertEquals(len, cpu.execInstr());
        assertEquals(alu.add(new DataType(a), new DataType(b)).toString(), CPU_State.eax.read());
    }
