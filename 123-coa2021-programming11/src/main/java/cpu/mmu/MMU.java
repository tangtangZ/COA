...
public class MMU {
    ...
    private String toRealLinearAddr(String logicAddr) {
        ...
        int a=Integer.parseInt(logicAddr.substring(0,16),2);
        int b=Integer.parseInt(logicAddr.substring(32,48),2);
        String lineadder=transformer.intToBinary(String.valueOf(a*16+b));
        return lineadder;
    }
    ...
    private String toSegLinearAddr(String logicAddr) {
        ...
        char base[]=memory.getBaseOfSegDes(index);
        int i=Integer.parseInt(logicAddr.substring(16,48),2);
        int b=Integer.parseInt(String.copyValueOf(base),2);
        String lineadder=transformer.intToBinary(String.valueOf(i+b));
        return lineadder;
    }
    ...
    private String toPagePhysicalAddr(String linearAddr) {
        ...
        int a=Integer.parseInt(linearAddr.substring(0,20),2);//虚页号；
        char [] padder =new char[20];
        /*if(TLB.isAvailable){
            padder=tlb.read(a).toCharArray();
        }else{*/
        padder =memory.getFrameOfPage(a);
        String b=String.valueOf(padder);
        return String.valueOf(padder)+linearAddr.substring(20,32);
    }
