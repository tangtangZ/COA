...
public class  AssociativeMappingTest {
    ...
    public void test01() {
        ...
        boolean a=cache.checkStatus(new int[]{1, 7}, new boolean[]{true, true}, new char[][]{"0000000000000000000001".toCharArray(), "0000000000000000000111".toCharArray()});
    ...
    public void test03() {
        ...
        boolean a=cache.checkStatus(new int[]{1}, new boolean[]{true}, new char[][]{"0000000001110000000001".toCharArray()});
    ...
    public void test04() {
        ...
        dataRead = cache.read(pAddr3, 1024);
        assertArrayEquals(input3, dataRead);
        boolean a=cache.checkStatus(new int[]{0, 1}, new boolean[]{true, true}, new char[][]{"0000000001110000000001".toCharArray(), "0000000001110000000010".toCharArray()});
